...
dispatch({ type: 'UPDATE_AVALUE', payload: true });
 ...
 const getalldata=async (e)=>{
  ...
  for(let i=0;i<parseInt(json.data.length);i++){
    ...
    let semail=json.data[i].mail
    let smobile=json.data[i].phone
    let dessignal=true
 ...
 const refreshdash=async(e)=>{
    ...
    const response=await fetch(`http://${state.backend}:${state.port}/api/ad/getallstats`,{
      ...
      headers:{
        ...
        document.getElementById("nooffeed").innerHTML = json.feedcount
  ...
  return (
   ...
   <div className="upperw">
    ...
    <div className="flex flex-wrap -mx-3" style={{margin:"20px",width:"90%"}}>
...
<h5 className="mb-0 font-bold hclass">
<span id="nooftoken"></span>
<span className="leading-normal text-red-600 text-sm font-weight-bolder lef200">Allowed</span>
</h5>
</div>
</div>
<div className="px-3 text-right basis-1/3 ">
...
<div className="flex-none w-2/3 max-w-full px-3">
<div>
<p className="mb-0 font-sans font-semibold leading-normal text-sm" style={{color:" #67748e",display: "flex"}}>Complaints</p>
<h5 className="mb-0 font-bold hclass">
<span id="noofcomp"></span>
<span className="leading-normal text-sm font-weight-bolder text-lime-500 lef200">left</span>
</h5>
</div>
...
<div className="flex-none w-2/3 max-w-full px-3">
<div>
<p className="mb-0 font-sans font-semibold leading-normal text-sm" style={{color:" #67748e",display: "flex"}}>Feedbacks</p>
<h5 className="mb-0 font-bold hclass">
<span id="nooffeed"></span>
<span className="leading-normal text-red-600 text-sm font-weight-bolder lef200">Unread</span>
</h5>
</div>
</div>
<div className="px-3 text-right basis-1/3 ">
