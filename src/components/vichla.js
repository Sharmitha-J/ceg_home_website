...
const handle=async (e)=>{
   ...
   let idate=document.getElementById('indate').value
   let itime=document.getElementById('inTime').value
   let odate=document.getElementById('outdate').value
   let otime=document.getElementById('outTime').value
   ...
   console.log(It)
    ...
    const response=await fetch(`http://${state.backend}:${state.port}/api/g/gatetoken`,{
        ...
        body: JSON.stringify({Subject:Purpose,It:It,Ot:Ot})
...
<ul className="mb-2 grules">
 ...
 <li className='m-2 daj'> <ArrowRightRoundedIcon className='mbb5'/>No gate pass will generated after 8.30 PM</li>
 
 <li className='m-2 daj'><ArrowRightRoundedIcon className='mbb5'/>Students on leave are can't mark their attendance</li>
 <li className='m-2 daj'><ArrowRightRoundedIcon className='mbb5'/>You have return to hostel before 8.30 PM otherwise fill leave form</li>
...
<form onSubmit={handle}>
    <div className={`grid gap-6 mb-6 md:grid-cols-2  ${divstatus === 1 && "divdisable"} `}>
        <div>
            <label htmlFor="date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Out Date</label>
            <input type="date" id="outdate" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John" required/>
        </div>
        <div>
            <label htmlFor="Time" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Out  Time</label>
            <input type="time" id="outTime" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Doe"  required/>
        </div>
        <div>
            <label htmlFor="date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Expected In Date</label>
            <input type="date" id="indate" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John" required/>
        </div>
        <div>
